...
if (!isset($_POST['direccion']) || !isset($_POST['latitud']) || !isset($_POST['longitud']) ||
    !isset($_POST['idServicio']) || !isset($_POST['token']) || !isset($_POST['idCoche']) || 
		!isset($_POST['idCocheFavorito']) || !isset($_POST['metodoDePago']))
{
...
try
{
  ...
  $service  = new Service();
  $idService = $service->requestService($direccion, $latitud,$longitud,$idServicio,$clientInfo['idCliente'],$idCoche, $idCocheFavorito, $metodoDePago);
