...
class DataBaseUser extends DataBase{
	...
	const QUERY_INSERT_USER = "INSERT INTO Cliente (Nombre, PrimerApellido, Email, Password, Telefono, codigo) VALUES ('%s', '%s', '%s', SHA2(MD5(('%s')),512), '%s', CONCAT(FLOOR(RAND()*10), LEFT(MD5(RAND()),4)))";
