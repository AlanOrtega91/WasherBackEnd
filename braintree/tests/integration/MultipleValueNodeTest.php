...
class MultipleValueNodeTest extends Setup
{
    public function testIn_singleValue()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $activeSubscription));
        $this->assertFalse(Test\Helper::require_onces($collection, $canceledSubscription));
    }
    ...
    public function testIn_multipleValues()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $activeSubscription));
        $this->assertTrue(Test\Helper::require_onces($collection, $canceledSubscription));
    }
}
