...
class SubscriptionSearchTest extends Setup
{
    public function testSearch_planIdIs()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $trialSubscription));
        $this->assertFalse(Test\Helper::require_onces($collection, $triallessSubscription));
    }
    ...
    public function testSearch_inTrialPeriod()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($subscriptions_in_trial, $trialSubscription));
        $this->assertFalse(Test\Helper::require_onces($subscriptions_in_trial, $triallessSubscription));

        $subscriptions_not_in_trial = Braintree\Subscription::search([
            Braintree\SubscriptionSearch::inTrialPeriod()->is(false)
        ]);

        $this->assertTrue(Test\Helper::require_onces($subscriptions_not_in_trial, $triallessSubscription));
        $this->assertFalse(Test\Helper::require_onces($subscriptions_not_in_trial, $trialSubscription));
    }
    ...
    public function testSearch_billingCyclesRemaing()
    {
        ...
        $this->assertFalse(Test\Helper::require_onces($collection, $subscription_4));
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_8));
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_10));
    }
    ...
    public function testSearch_subscriptionId()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_1));
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_2));
        $this->assertFalse(Test\Helper::require_onces($collection, $subscription_3));
    }
    ...
    public function testSearch_merchantAccountId()
    {
        ...
        $this->assertFalse(Test\Helper::require_onces($collection, $subscription_1));
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_2));
    }
    ...
    public function testSearch_bogusMerchantAccountId()
    {
        ...
        $this->assertFalse(Test\Helper::require_onces($collection, $subscription));
    }
    ...
    public function testSearch_price()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_851));
        $this->assertTrue(Test\Helper::require_onces($collection, $subscription_852));
        $this->assertFalse(Test\Helper::require_onces($collection, $subscription_850));
    }
    ...
    public function testSearch_nextBillingDate()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $triallessSubscription));
        $this->assertFalse(Test\Helper::require_onces($collection, $trialSubscription));
    }
    ...
    public function testSearch_transactionId()
    {
        ...
        $this->assertTrue(Test\Helper::require_onces($collection, $matchingSubscription));
        $this->assertFalse(Test\Helper::require_onces($collection, $nonMatchingSubscription));
    }
}
